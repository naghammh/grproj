    ...
    <Box sx={{ backgroundColor: "#f5f5f5", py: 8 }}>
      <Container maxWidth="lg">
        ...
        <Grid
          ...
          sx={{
            display: "flex",
            flexWrap: "wrap", // ⚡ يسمح بلف البطاقات
          }}
        >
          {faqs.map((faq, index) => (
            <Grid
              ...
              key={index}
              sx={{
                width: { xs:"100%", sm: "calc(50% - 12px)", md: "calc(50% - 12px)" }, // ⚡ كل بطاقة تاخد نصف الصف
                display: "flex",
                alignItems: "stretch", // ⚡ نفس ارتفاع الصف
                padding: "8px",        // ⚡ بدل spacing في Grid
              }}
            >
              <Paper
                elevation={0}
